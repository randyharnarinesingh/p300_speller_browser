$(document).ready(function() {
	...
	// P300 Speller Implementation using Javascript - Dr Randy Harnarinesingh
	// This software may be used for research and charity purposes but not for commercial benefit
	// If this software is used for research, publications must cite the following paper:
	// 		Title: Comparison of pre-processing and classification techniques for single-trial and multi-trial P300-based brain computer interfaces
